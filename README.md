...
BLIZZARD BRAWL은 웹 브라우저에서 바로 접속해 테스트할 수 있는 `io` 스타일의 1대1 스노우볼 게임 프로토타입입니다.  
...
- `VITE_SENTRY_RELEASE`: 프런트 Sentry release 이름
...
- 경기 시간, whiteout 시작/종료 시점, 최소 반경 같은 매치 규칙은 환경변수로 바꾸지 않고 [matchRules.ts](/Users/sean/Documents/SnowBattle/packages/shared/src/matchRules.ts)에서 수정합니다.
...
- GitHub Pages 운영 빌드: `VITE_SENTRY_RELEASE=1.0`
...
- `VITE_SENTRY_RELEASE`가 없으면 release는 기본값 `1.0`을 사용합니다.
